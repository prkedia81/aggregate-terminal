...
function calculateSIP() {
  ...
  let maturityAmount = document.getElementById("investment-amount").value;
  ...
  if(maturityAmount == 0 || yearlyRateOfReturn == 0 || tenure == 0) {
  ...
  let amountInvested = sip * tenure;
  amountInvested = amountInvested.toFixed(2);

  let gains = maturityAmount - amountInvested;
